...
class ThanhToanController
{
    ...
    private function LoadGiaoDienThanhToan($id)
    {
        ...
        "
        <div class='container'>
            <a href='./?to=home'><img src='public/images/icons/header-icon.png' class='d-none d-lg-block icon-lg'></a>
            <a class='row justify-content-center' href='./?to=home'><img src='public/images/icons/header-icon.png' class='d-lg-none d-xl-block d-xl-none icon'></a>
            <br style='clear:both'>
            <div class='row'>
                <div class='col-lg-7 col-sm-12 mb-5'>
                    <form method='post' class='login-form row'>
