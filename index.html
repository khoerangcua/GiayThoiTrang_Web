                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="width: 100%;">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/sneaker1-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                        <div class="carousel-item">
                            <img src="images/showroom-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                        <div class="carousel-item">
                            <img src="images/showroom2-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                        <div class="carousel-item">
                            <img src="images/sale-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row pro-list">
            <div class="col-lg-3 col-md-6 col-6 products">
                <a href="#"><img class="pro-img" src="images/SP-tc.jpg"></a>
        ...
        <div class="row">
            <div class="col">
                <div id="carouselControls" class="carousel slide" data-bs-ride="carousel" style="width: 100%">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/anh-giay-converse-tc.jpg" class="d-block w-100"
                                style="width: 100%; height: 500px" alt="">
                        </div>
                        <div class="carousel-item">
                            <img src="images/giay-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                        <div class="carousel-item">
                            <img src="images/doigiay-tc.jpg" class="d-block w-100" style="width: 100%; height: 500px"
                                alt="">
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row" id="ThongTinT">
            <div class="col-md-4 col-xs-4 ttin">
                ...
                <img class="morett" src="images/quality-tc.png">
            </div>
            <div class="col-md-4 col-xs-4 ttin">
                <h2>Giao hàng toàn quốc</h2>
                <img class="morett" src="images/shipping-tc.png">
            </div>
            <div class="col-md-4 col-xs-4 ttin">
                <h2>Hỗ trợ 24/24</h2>
                <img class="morett" src="images/support-tc.png">
            </div>
        </div>
    </div>
